package AIHack.AIHack;
	...
	public class predictionAPI {
		String modelId = "TCN8019716329068592950";
		static String projectId = "deepbrain";
		static String computeRegion = "us-central1";
		String filePath = "/Users/vijay.kumar.albert/Desktop/Untitled-2.txt";
	  ...
	  public static void argsHelper(String projectId, String computeRegion ) throws IOException {
	    ...
	    computeRegion = System.getenv("REGION_NAME");
	  ...
	  public static void main(String[] args) throws IOException {
		    ...
		    predictionAPI.argsHelper(projectId, computeRegion);
		  }
	}
